...
const connect = (mapStateToProps, mapDispatchToProps, mergeProps = defaultMergeProps) => {
  return Component => props => __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(Component, mergeProps(mapStateToProps(getState()), normalizeMapDispatchToProps(mapDispatchToProps)(dispatch, props), props));
};
...
/* harmony export (immutable) */ __webpack_exports__["__resetState"] = __resetState;

const __setState = state => getState.mockReturnValue(state);
/* harmony export (immutable) */ __webpack_exports__["__setState"] = __setState;
